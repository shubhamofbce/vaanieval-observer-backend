...
| `response.continues_turn` | Present only when we knowingly recorded two turns where LiveKit committed one message; names the turn this one continues, with `split_reason` saying why they could not be merged |
